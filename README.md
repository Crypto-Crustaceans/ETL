...
Fed Press Release Relevant files: fed_reserve_press_release_scraper.ipynb, fed_press_releases.csv, fed_press_releases_content.csv
...
Yahoo Finance Relevant files: yfinance.ipynb, SPY.csv, USD.csv
